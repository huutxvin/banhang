<div id="header">
	...
	<div class="header-body" style="background: url(image/background.gif) repeat;">
		<div class="container beta-relative">
			<div class="pull-left">
				<a href="{{ route('trang-chu') }}" id="logo"><img src="assets/dest/images/logo-cake.png" width="300px" alt=""></a>
			</div>
			...
			<nav class="main-menu">
				<ul class="l-inline ov">
					...
					<li><a href="javascript:void(0)" style="text-decoration: none">Loại sản phẩm</a>
						<ul class="sub-menu">
							@foreach($product_type as $value) {{-- namespace App\Providers; --}}
							<li><a href="{{ route('loai-san-pham',$value->id) }}">{{ $value->name }}</a></li>
							@endforeach
						</ul>
					</li>
					<li class="{{ (\Route::current()->uri() == 'banhang/about') ? 'active' :  NULL }}"><a href="{{ route('gioi-thieu') }}">Giới thiệu</a></li>
					<li class="{{ (\Route::current()->uri() == 'banhang/contact') ? 'active' :  NULL }}"><a href="{{ route('lien-he') }}">Liên hệ</a></li>
				</ul>
				<div class="clearfix"></div>
			</nav>
		</div> <!-- .container -->
