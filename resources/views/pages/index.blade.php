					...
					<ul>
						...
						<li data-transition="boxfade" data-slotamount="20" class="active-revslide" style="width: 100%; height: 100%; overflow: hidden; z-index: 18; visibility: hidden; opacity: 0;">
							<div class="slotholder" style="width:100%;height:100%;" data-duration="undefined" data-zoomstart="undefined" data-zoomend="undefined" data-rotationstart="undefined" data-rotationend="undefined" data-ease="undefined" data-bgpositionend="undefined" data-bgposition="undefined" data-kenburns="undefined" data-easeme="undefined" data-bgfit="undefined" data-bgfitend="undefined" data-owidth="undefined" data-oheight="undefined">
								<div class="tp-bgimg defaultimg" data-lazyload="undefined" data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat" data-lazydone="undefined" src="image/slide/{{ $value->image }}" data-src="image/slide/{{ $value->image }}" style="background-color: rgba(0, 0, 0, 0); background-repeat: no-repeat; background-image: url('image/slide/{{ $value->image }}'); background-size: cover; background-position: center center; width: 100%; height: 100%; opacity: 1; visibility: inherit;">
								</div>
							</div>
						</li>
						@endforeach
			...
			<div class="row">
				<div class="col-sm-12">
								...
								<div class="col-sm-3">
									<div class="single-item">
										...
										<div class="single-item-header">
											<a href="{{ route('chi-tiet',$new->id) }}"><img src="image/product/{{ $new->image }}" alt=""
												height="250px"></a>
										</div>
										...
										<div class="single-item-caption">
											...
											<a class="beta-btn primary" href="{{ route('chi-tiet',$new->id) }}">Details <i class="fa fa-chevron-right"></i></a>
											<div class="clearfix"></div>
										</div>
									</div>
								</div>	
					...
					<div class="beta-products-list">
							   ...
							   @foreach($promotion_product as $promotion)
								<div class="col-sm-3">
									<div class="single-item">
	                                    ...
	                                    @endif
										<div class="single-item-header">
											<a href="{{ route('chi-tiet',$promotion->id) }}"><img src="image/product/{{ $promotion->image }}" alt="" height="250px"></a>
										</div>
										...
										<div class="single-item-caption">
											...
											<a class="beta-btn primary" href="{{ route('chi-tiet',$promotion->id) }}">Details <i class="fa fa-chevron-right"></i></a>
											<div class="clearfix"></div>
										</div>
						...
						<div class="row">{{ $promotion_product->render() }}</div>
					</div> <!-- .beta-products-list -->
				</div>
